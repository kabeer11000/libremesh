...
define('VERSION', 'kcs.cloudhost-backend.stable');

//Application Title
define('APP_TITLE', 'KCS / Cloud Upload');
...
$auth_users = array(
    'kabeer' => '$2y$10$meQb4SEpdRP5TDjHparRu.ugFyQX0CZFNEzfTlpU53CyoALLrG0Iu',
    // 'admin' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', //admin@123
    // 'eesha' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO', //12345
    // 'adeena' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO' //12345
);
...
$directories_users = array('eesha' => './guest-uploads/eesha/');
...
if (!defined( 'FM_SESSION_ID')) {
    define('FM_SESSION_ID', 'kcs:cloudupload');
}
...
$is_https = ($_SERVER['HTTP_HOST'] !== 'docs-kabeersnetwork-kview-app-sta.rf.gd') || isset($_SERVER['HTTPS']) && ($_SERVER['HTTPS'] == 'on' || $_SERVER['HTTPS'] == 1)
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                        ...
                                        <div class="text-left">
                                            <h1 class="card-title py-0 mb-0"><?php echo APP_TITLE; ?></h1>
                                            <p>Kabeer Cloud Platform — Legacy Release Patch 5.3.1</p>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-secondary btn-block w-100 mt-4" role="button">
                                            <?php echo lng('Login'); ?>
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div class="footer text-center">
                            &copy;
                            <a href="https://kabeers.network/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Kabeer Cloud Platform</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <!--<div class="col-xs-12 col-sm-6">
                        <p><h3><a href="#" target="_blank" class="app-v-title"> <?php echo VERSION; ?></a></h3></p>
...
if (isset($_GET['view'])) {
    ...
    <div class="row">
        <div class="col-12 pt-4">
            <p class="break-word m-0"><b><?php echo lng($view_title) ?> "<?php echo fm_enc(fm_convert_win($file)) ?>"</b></p>
            <p class="break-word m-0">
            ...
            <div class="d-flex m-0 align-items-center mb-3 pt-5">
            ...
            if($is_onlineViewer) {
                if($online_viewer == 'google') {
                    echo '<iframe class="card" src="https://docs.google.com/viewer?embedded=true&hl=en&url=' . fm_enc(FM_ROOT_URL . $file_url) . '" frameborder="no" style="width:100%;min-height:460px"></iframe>';
                } else if($online_viewer == 'microsoft') {
                    echo '<iframe class="card" src="https://view.officeapps.live.com/op/embed.aspx?src=' . fm_enc(FM_ROOT_URL . $file_url) . '" frameborder="no" style="width:100%;min-height:460px"></iframe>';
                }
            } elseif ($is_zip) {
                // ZIP content
                if ($filenames !== false) {
                    echo '<code class="maxheight card">';
                    foreach ($filenames as $fn) {
                        if ($fn['folder']) {
                ...
                if (FM_USE_HIGHLIGHTJS) {
                    ...
                    $content = '<pre class="with-hljs card"><code class="' . $hljs_class . '">' . fm_enc($content) . '</code></pre>';
...
if (isset($_GET['edit']) && !FM_READONLY) {
    ...
    ?>
    <div class="path">
        <div class="row bg-white p-2 border" style="border-radius: .25rem;">
        ...
        if ($is_text && $isNormalEditor) {
            echo '<textarea class="card mt-4 container" id="normal-editor" rows="33" cols="120" style="width: 99.5%;">' . htmlspecialchars($content) . '</textarea>';
            ...
            echo '<div id="editor" class="mt-4 container border rounded" contenteditable="true">' . htmlspecialchars($content) . '</div>';
        } else {
...
<form action="" method="post" class="pt-3">
    ...
    <div class="table-responsive card mb-5">
        <table class="table table-bordered table-hover -table-lg -card border-transparent <?php echo $tableTheme; ?>" id="main-table">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="#" target="" class="float-right text-muted"><?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="#" target="" class="float-right text-muted"><?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'KCS / Cloud Upload <br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
{
    global $lang, $sticky_navbar, $editFile, $file;
    ...
    ?>
    <nav style=" background-color:#F7F7F7" class="p-0 navbar bg-transparent navbar-expand-lg shadow-none <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
    <div class="container rounded -border -card py-1" style="border-radius: 5rem; background:#F7F7F7;">
        <a class="navbar-brand display-4 d-lg-none d-block card-title"><?php echo lng('AppTitle') ?> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a class='py-0' href='?p=' style='text-decoration: none; color: #737373'><i class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
            $sep = '<i class="bread-crumb px-1"> / </i>';
            if ($path != '') {
            ...
            echo '<div class="col-xs-6 col-sm-5">' . $root_url . (str_contains($_SERVER['QUERY_STRING'], "view") ?  $sep . '<a href="?'. $_SERVER['QUERY_STRING'] .'">'.$file.'</a>' : '').'</div>';
            ?>

            <div class="col-xs-6 col-sm-7">
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    <li class="nav-item pr-4 mr-4">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px; width:  100%;">
                    ...
                    <?php endif; ?>
                    <?php if (FM_USE_AUTH): ?>
                    <li class="nav-item avatar dropdown mr-4">
                        ...
                        <div class="px-4 dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <?php if (!FM_READONLY): ?>
...
<head>
    ...
    .btn-outline-primary {
        ...
        body.fm-login-page{ background-color:#fff;font-size:14px;background-color:#fff;}
...
<div id="wrapper" class="container pt-4">
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            .btn-primary { --bs-btn-bg: black; --bs-btn-border-color: black; }
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE && !FM_READONLY):
    ...
    <script>
        ...
        function renderThemeMode() {
            ...
            $(function() { $fontSizeEl.val(14).change(); }); //set default font size in drop down
        }
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'KCS / Cloud Upload';      $tr['en']['AppTitle']           = 'Cloud Upload Manager';
